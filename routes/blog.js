...
router.get('/post/:postpraise_id/delete', post_controller.post_delete_get);

// POST request to delete Post.
router.post('/post/:postpraise_id/delete', post_controller.post_delete_post);
...
router.get('/author/:authorPraises_id/delete', author_controller.author_delete_get);

// POST request to delete Author
router.post('/author/:authorPraises_id/delete', author_controller.author_delete_post);

// GET request to update Author.
router.get('/author/:authorPraises_id/update', author_controller.author_update_get);

// POST request to update Author.
router.post('/author/:authorPraises_id/update', author_controller.author_update_post);

// GET request for one Author.
router.get('/author/:authorPraises_id', author_controller.author_detail);
